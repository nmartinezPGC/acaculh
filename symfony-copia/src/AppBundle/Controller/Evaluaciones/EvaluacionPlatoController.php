...
use BackendBundle\Entity\TblEvaluacionPlato;
 ...
 */
class EvaluacionPlatoController extends Controller {
...
// FIN | FND00001
    ...
    /**
     * @Route("/evaluaciones/list-evaluacion-plato", name="/evaulaciones/list-evaluacion-plato")
     * Creacion del Controlador: Listado de la Informacion de la Evaluacion del Alumno
     * @author Nahum Martinez <nmartinez.salgado@yahoo.com>
     * @since 1.1
     * Funcion: FND00001.1
     */
    public function EvaluacionPlatoByAlumnoListAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
        //Instanciamos el Servicio Helpers y Jwt
        $helpers = $this->get("app.helpers");
        ...
        if ($checkToken == true) {
            ...
            if ($json != null) {
                ...
                // Query para Obtener la Evaluacion Plato del Alumno de la Tabla: TblEvaluacionPlato
                $evalPlatoConsulta = $em->getRepository("BackendBundle:TblEvaluacionPlato")->findBy(
                        array(
                            "idAlumno" => $id_Alumno
                        )
                );
...
// FIN | FND00001.1
    ...
    /**
     * @Route("/evaluaciones/new-evaluacion-plato", name="/evaluaciones/new-evaluacion-plato")
     * Creacion del Controlador: Nuevo Pago de Evaluacion Plato
     * @author Nahum Martinez <nmartinez.salgado@yahoo.com>
     * @since 1.0
     * Funcion: FND00002
     */
    public function NewEvaluacionPlatoAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
        //Instanciamos el Servicio Helpers y Jwt
        $helpers = $this->get("app.helpers");
        ...
        if ($checkToken == true) {
            ...
            if ($json != null) {
                ...
                //Parametros a Convertir                           
                //Datos generales de la Tabla                             
                $codEval_plato = ($params->codEvalCocinaPlato != null) ? $params->codEvalCocinaPlato : null;
                ...
                $otros_Obs = ($params->otrosObs != null) ? $params->otrosObs : null;
                $otros_Nota = ($params->otrosNota != null) ? $params->otrosNota : null;
                ...
                if ($id_Alumno != NULL && $id_Instructor != NULL) {
                    ...
                    if ($isset_cod_evaluacion == NULL) {
                        ...
                        $ingresoEvaluacionNew = new TblEvaluacionPlato();

                        // Codigo de la Evaluacion
                        $ingresoEvaluacionNew->setCodEvaluacionPlato($codEval_plato);
                        ...
                        $ingresoEvaluacionNew->setOtrosObs($otros_Obs);
                        $ingresoEvaluacionNew->setOtrosNota($otros_Nota);
                        ...
                        $mail = \Swift_Message::newInstance()
                                ...
                                ->setBody(
                                $this->renderView(
                                        'Emails/sendMailEvaluacionPlato.html.twig', array('nombreAlumno' => $alumno_asignado_send->getNombre1(),
                                    ...
                                    'obsOtros' => $otros_Obs, 'notaOtros' => $otros_Nota,
                        ...
                        $evaluacionConsulta = $em->getRepository("BackendBundle:TblEvaluacionPlato")->findOneBy(
                                array(
                                    "codEvaluacionPlato" => $codEval_plato
                        ));
