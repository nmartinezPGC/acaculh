...
use BackendBundle\Entity\TblExamenPractico;

/**
 * Description of ExamenPracticoController
 *
 * @author Nahum Martinez
 */
class ExamenPracticaController extends Controller {
...
// FIN | FND00001
    ...
    /**
     * @Route("/evaluaciones/list-examen-practico", name="/evaulaciones/list-examen-practico")
     * Creacion del Controlador: Listado de la Informacion de la Evaluacion Nota Teorica
     * @author Nahum Martinez <nmartinez.salgado@yahoo.com>
     * @since 1.1
     * Funcion: FND00001.1
     */
    public function ExamenPracticoListAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
        //Instanciamos el Servicio Helpers y Jwt
        $helpers = $this->get("app.helpers");
        ...
        if ($checkToken == true) {
            ...
            if ($json != null) {
                ...
                // Query para Obtener la Evaluacion Plato del Alumno de la Tabla: TblExamenPractico
                $evalPlatoConsulta = $em->getRepository("BackendBundle:TblExamenPractico")->findBy(
                        array(
                            "idAlumno" => $id_Alumno
                        )
                );
...
// FIN | FND00001.1
    ...
    /**
     * @Route("/evaluaciones/new-examen-practico", name="/evaluaciones/new-examen-practico")
     * Creacion del Controlador: Nuevo Pago de Evaluacion Plato
     * @author Nahum Martinez <nmartinez.salgado@yahoo.com>
     * @since 1.0
     * Funcion: FND00002
     */
    public function NewExamenPracticoAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
        //Instanciamos el Servicio Helpers y Jwt
        $helpers = $this->get("app.helpers");
        ...
        if ($checkToken == true) {
            ...
            if ($json != null) {
                ...
                if ($id_Alumno != NULL && $id_Instructor != NULL) {
                    ...
                    $isset_cod_evaluacion = $em->getRepository("BackendBundle:TblExamenPractico")->findOneBy(
                            array(
                                "idAlumno" => $id_Alumno
                    ));
                    ...
                    if ($isset_cod_evaluacion == NULL) {
                        // Seteo de Datos Generales de la tabla: TblExamenPractico
                        $ingresoEvaluacionNew = new TblExamenPractico();
                        ...
                        $evaluacionConsulta = $em->getRepository("BackendBundle:TblExamenPractico")->findOneBy(
                                array(
                                    "idAlumno" => $id_Alumno
                        ));
...
// FIN | FND00005
     ...
     * Funcion: FND00003
     */
    public function UploadImageExamenPracticoAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
