...
use BackendBundle\Entity\TblEvaluacionNotaTeorica;
 ...
 */
class EvaluacionNotaTeoricaController extends Controller {
...
// FIN | FND00001
    ...
    /**
     * @Route("/evaluaciones/list-evaluacion-nota-teorica", name="/evaulaciones/evaluacion-nota-teorica")
     * Creacion del Controlador: Listado de la Informacion de la Evaluacion Nota Teorica
     * @author Nahum Martinez <nmartinez.salgado@yahoo.com>
     * @since 1.1
     * Funcion: FND00001.1
     */
    public function EvaluacionNotaTeoricaListAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
        //Instanciamos el Servicio Helpers y Jwt
        $helpers = $this->get("app.helpers");
...
// FIN | FND00001.1
    ...
    /**
     * @Route("/evaluaciones/new-evaluacion-nota-teorica", name="/evaluaciones/new-evaluacion-nota-teorica")
     * Creacion del Controlador: Nuevo Pago de Evaluacion Plato
     * @author Nahum Martinez <nmartinez.salgado@yahoo.com>
     * @since 1.0
     * Funcion: FND00002
     */
    public function NewEvaluacionNotaTeoricaAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
        //Instanciamos el Servicio Helpers y Jwt
        $helpers = $this->get("app.helpers");
        ...
        if ($checkToken == true) {
            ...
            if ($json != null) {
                ...
                $presentacion_url = ($params->urlDocumentoNota != null) ? $params->urlDocumentoNota : null;
                ...
                if ($id_Alumno != NULL && $id_Instructor != NULL) {
                    ...
                    $isset_cod_evaluacion = $em->getRepository("BackendBundle:TblEvaluacionNotaTeorica")->findOneBy(
                            array(
                                "idAlumno" => $id_Alumno
                    ));
                    ...
                    if ($isset_cod_evaluacion == NULL) {
                        // Seteo de Datos Generales de la tabla: TblEvaluacionNotaTeorica
                        $ingresoEvaluacionNew = new TblEvaluacionNotaTeorica();

                        // Codigo de la Evaluacion
                        $ingresoEvaluacionNew->setCodNota($codEval_plato);
                        ...
                        $ingresoEvaluacionNew->setUrlDocumentoNota($presentacion_url);
                        ...
                        $mail = \Swift_Message::newInstance()
                                ...
                                ->setBody(
                                $this->renderView(
                                        'Emails/sendMailEvaluacionNotaTeorica.html.twig', array('nombreAlumno' => $alumno_asignado_send->getNombre1(),
                        ...
                        $evaluacionConsulta = $em->getRepository("BackendBundle:TblEvaluacionNotaTeorica")->findOneBy(
                                array(
                                    "idAlumno" => $id_Alumno
                        ));
...
// FIN | FND00005
     ...
     * Funcion: FND00003
     */
    public function UploadImageNotaTeoricaAction(Request $request) {
        date_default_timezone_set('America/Tegucigalpa');
        ...
        if ($checkToken == true) {
            ...
            $file = $request->files->get("foto_nota_teorica");
            $name_file = $request->get("name_nota_teorica");
            ...
            if (!empty($file) && $file != null) {
                ...
                if ($ext == "jpeg" || $ext == "jpg" || $ext == "png" || $ext == "gif" || $ext == "pdf" ) {
                    ...
                    $file_name = $name_file;
                    //Movemos el Fichero
                    $file->move("uploads/notas", $file_name);
