...
@Injectable()
export class EvaluacionNotaTeoricaService {
  ...
  public postFileImagen(token, imagenParaSubir: File, codAlumno: string) {
    ...
    formData.append('foto_nota_teorica', imagenParaSubir, imagenParaSubir.name);
    formData.append('name_nota_teorica', imagenParaSubir.name);
    formData.append('cod_nota', codAlumno);
    formData.append('authorization', token);

    return this._http.post(this.url + '/evaluaciones/upload-nota-teorica', formData).map(res => res.json());
  }
  ...
  *****************************************************/
  registerEvaluacionNotaTeorica(token, user_to_register) {
    ...
    return this._http.post(this.url + '/evaluaciones/new-evaluacion-nota-teorica', params, { headers: headers }).map(res => res.json());
  }
