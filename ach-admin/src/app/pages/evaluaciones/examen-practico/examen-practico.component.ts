...
import { ExamenPracticoService } from '../service/examen-practico.service';
import { ExamenPracticoModel } from '../model/examen-practico.model';

@Component({
  selector: 'app-examen-practico',
  templateUrl: './examen-practico.component.html',
  styleUrls: ['./examen-practico.component.scss'],
  providers: [ListasComunesService, ConsultaAlumnoService, ExamenPracticoService],
})
export class ExamenPracticoComponent implements OnInit {
...
public _evaluacionNotaTeoricaModel: ExamenPracticoModel;
...
private _evaluacionNotaTeoricaService: ExamenPracticoService,
...
this._evaluacionNotaTeoricaModel = new ExamenPracticoModel(
...
this._evaluacionNotaTeoricaModel.urlExamenTeorico = nombreFile;
