...
import { ExamenTeoricoModel } from '../model/examen-teorico.model';
import { ExamenTeoricoService } from '../service/examen-teorico.service';

@Component({
  selector: 'app-examen-teorico',
  templateUrl: './examen-teorico.component.html',
  styleUrls: ['./examen-teorico.component.scss'],
  providers: [ListasComunesService, ConsultaAlumnoService, ExamenTeoricoService],
})
...
public _evaluacionNotaTeoricaModel: ExamenTeoricoModel;
...
private _evaluacionNotaTeoricaService: ExamenTeoricoService,
...
this._evaluacionNotaTeoricaModel = new ExamenTeoricoModel(
